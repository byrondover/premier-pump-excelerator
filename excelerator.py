...
def create_section_list(source_cells, section, part_group):
...
def excelerate(file):
    ...
    fabricated_list = create_section_list(
        fabricated_parts, fabricated_parts, 'FabricatedParts')
    weldments_list = create_section_list(
        fabricated_parts, weldments, 'WeldmentParts')
    purchased_list = create_section_list(
    ...
    weld_picklist_sheet = create_sheet(wb, 'WELD SCF Pick List')
